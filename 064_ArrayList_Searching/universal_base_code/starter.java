...
class starter {
	...
	public static void searchArrString(ArrayList<String> a, String b){
		int i; 
		String answer = "no"; 
		for (i = 0; i < a.size(); i++){
			if (a.get(i).equals(b))
		...
		System.out.println(); 
		System.out.println(answer + " " + b + " it exists at index of " + i); 
	}
	public static void searchArrInt(ArrayList<Integer> a, int b){
		String answer = "no"; 
		int i; 
		for (i = 0; i < a.size(); i++){
			if (a.get(i) == b)
